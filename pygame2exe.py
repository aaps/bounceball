...
class BuildExe:
    def __init__(self):
        ...
        self.license = "Create Commons License"
 
        #Auhor of program
        self.author_name = "Jimmy G"
        self.author_email = "jimmy.g@gmail.com"
        self.copyright = "Copyright (c) 2014 XX Studios."
 
        #Description
        self.project_description = "MOBA 14"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ['config.txt','data']#'prstartk.ttf','config.txt']
